...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SynteX features */
        {"syntex", "masternode", &masternode, true, true, false},
        {"syntex", "listmasternodes", &listmasternodes, true, true, false},
        {"syntex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"syntex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"syntex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"syntex", "startmasternode", &startmasternode, true, true, false},
        {"syntex", "masternodedebug", &masternodedebug, true, true, false},
        {"syntex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"syntex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"syntex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"syntex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"syntex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"syntex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"syntex", "mnbudget", &mnbudget, true, true, false},
        {"syntex", "preparebudget", &preparebudget, true, true, false},
        {"syntex", "submitbudget", &submitbudget, true, true, false},
        {"syntex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"syntex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"syntex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"syntex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"syntex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"syntex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"syntex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"syntex", "checkbudgets", &checkbudgets, true, true, false},
        {"syntex", "mnsync", &mnsync, true, true, false},
        {"syntex", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> syntex-cli " + methodname + " " + args + "\n";
}
